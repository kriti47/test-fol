                      ...
                      <tbody><tr>
                        <td class="mini-block-padding">
                          <table cellspacing="0" cellpadding="0" width="100%" style="border-collapse:separate !important;">
                            <tbody><tr>
                              <td class="mini-block">
                                <span class="header-sm">Full Name</span><br>
                                <?php echo $fullname_order;?> <br><br>
								 <span class="header-sm">Email</span> <br>
                               <?php echo $email_to;?><br><br>
                                <span class="header-sm">Phone</span><br>
                                <?php echo $phone;?> <br><br>
								<span class="header-sm">Country</span><br>
                                <?php echo $country;?><br><br>
								<span class="header-sm">Type of Paper</span><br>
                                <?php echo $type_of_paper;?> <br><br>
                              </td>
                            </tr>
                          </tbody></table>
                        </td>
                      ...
                      <tbody><tr>
                        <td class="mini-block-padding">
                          <table cellspacing="0" cellpadding="0" width="100%" style="border-collapse:separate !important;">
                            <tbody><tr>
                              <td class="mini-block">
                                <span class="header-sm">Select Pages / Words</span><br>
                                <?php echo $select_pages;?>
                                <br><br>
                                <span class="header-sm">Currency</span> <br>
                                <?php echo $currency;?>
                                <br><br>
                                <span class="header-sm">Paper Topic</span> <br>
                                <?php echo $papertopic;?>
                                <br><br>
                                <span class="header-sm">Select Urgency</span> <br>
                                <?php echo $select_urgent;?><br><br>
        ...
        <table cellspacing="0" cellpadding="0" width="600" class="w320">
		  ...
		  <tr>
		   <td style="text-align: center;font-size: 12px; padding: 10px 0 10px;border-top:1px solid #b1b1b1;color:#000">
			   Email  : <a href="mailto:globalassignmentexpert@gmail.com" target="_blank" style="color:#00bcd4;">globalassignmentexpert@gmail.com</a> |  Phone : <a href="tel:+44 33 3303 4136" target="_blank" style="color:#00bcd4;">+44 33 3303 4136</a>
		   </td>
          </tr>
