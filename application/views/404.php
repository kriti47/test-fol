            ...
            <div class="error">
                <div class="container-floud">
                    <div class="col-xs-12 ground-color text-center">
                        ...
                        <div class="">
						 <!-- <a href="">
                            <button class="btn-green btn btn-primary  mawbutton">HomePage</button>
                        </a>-->	
                        <a class="navbar-brand logo clearfix"  style="margin-left: 660px;" href="index"><img src="images/logo.png" alt="" class="img-responsive" /></a>
						</div>
                    </div>
                </div>
            </div>
